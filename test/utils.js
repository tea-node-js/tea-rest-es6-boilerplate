...
describe('Utils', () => {
  ...
  describe('#privateIpMerge', () => {
    ...
    it('单个ip返回单元素数组', done => {
      assert.deepEqual(
        {
          '10.20.20.14': ['campaigns', 'placements', 'creatives']
        },
        privateIpMerge(switchs, {
          updateClickDict: ['10.20.20.14']
        })
      );
      done();
    });
    ...
    it('多ip返回多元素的数组', done => {
      assert.deepEqual(
        {
          '10.20.20.14': ['campaigns', 'placements', 'creatives', 'keywords'],
          '10.20.20.146': ['campaigns', 'placements', 'creatives', 'keywords'],
          '10.20.20.153': [
            'campaign',
            'campaigns',
            'placements',
        ...
        privateIpMerge(switchs, {
          v5Databank: ['10.20.20.14', '10.20.20.146'],
          adServing: ['10.20.20.153']
        })
      );
      done();
    });
    ...
    it('单ip有重复的元素应当去重', done => {
      assert.deepEqual(
        ...
        privateIpMerge(switchs, {
          v5Databank: ['10.20.20.14'],
          adServing: ['10.20.20.14']
        })
      );
      done();
    });
    ...
    it('多个ip而且有重复的元素应当返回多元素且去重的数组', done => {
      assert.deepEqual(
        ...
        privateIpMerge(switchs, {
          v5Databank: ['10.20.20.14', '10.20.20.146'],
          adServing: ['10.20.20.14', '10.20.20.153']
        })
      );
      done();
    });
