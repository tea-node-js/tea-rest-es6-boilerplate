...
describe('helper.checker', () => {
  ...
  describe('#ownSelf', () => {
    ...
    it('指定错误, allowEmpty = false', (done) => {
      ...
      const ownSelf = checker.ownSelf('params.userId', false, '不是您的资源，不能执行该操作');
    ...
    it('指定错误, allowEmpty = true', (done) => {
      ...
      const ownSelf = checker.ownSelf('params.userId', true, '不是您的资源，不能执行该操作');
      ownSelf(ctx);
    });
  ...
  describe('#privateSwitch', () => {
    ...
    it('指定错误', (done) => {
      ...
      const privateSwitch = checker.privateSwitch('users', '您没有得到私有客户端授权，不能执行该操作');
    ...
    it('成功通过', (done) => {
      const ctx = {
        allowPrivateSwitch() { return true; },
        params: {},
        query: {},
      };
